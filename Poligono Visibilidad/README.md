...
crossProduct, que devuelve del producto cruz de dos vectores $\mathbf{x,y}\in \mathbb{R}^2$, es decir

$$crossProduct(\mathbf{x,y})=x_1y_2-x_2y_1.$$
...
Se mustran diferentes casos de prueba, poligonos simples y polígonos con hoyos.
